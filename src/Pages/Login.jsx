    ...
    return (
        <div className="card bg-base-100 w-full max-w-sm mx-auto mt-20 shrink-0 shadow-2xl">
            ...
            <div className="card-body">
                <form onSubmit={formSignIn} className='fieldset'>
                ...
                <Link className='text-lg ml-2 underline text-blue-600' to='/register'>Register now !!</Link>
                </p>
                <button onClick={formGoogleSignin} className="btn bg-white text-black border-[#e5e5e5]">
